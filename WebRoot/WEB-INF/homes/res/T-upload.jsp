...
<body>
        ...
        <%-- <div class="crumb-wrap">
            <div class="crumb-list">
            	...
            	<span class="crumb-name">资源区</span>
            	<span class="crumb-step">&gt;</span>
            	<span class="crumb-name">资源管理</span>
            	<span class="crumb-step">&gt;</span>
            	<span class="crumb-name">资源上传</span>
            </div>
        </div> --%>
    ...
    <!--/main-->
        ...
        <center>
            ...
            <div class="result-content">
                <form action="datauploads" method="post" id="myform" name="myform" enctype="multipart/form-data">
