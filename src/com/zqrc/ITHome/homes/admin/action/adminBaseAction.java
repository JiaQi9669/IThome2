package com.zqrc.ITHome.homes.admin.action;
...
public abstract class adminBaseAction<T> extends BaseAction<T>{
//	//资源分类事务
...
//	添加图片共功能，添加成功返回path路径，否则返回null
	...
	protected String addImg() throws IOException{
		...
		// 获取上传的目录路径
		String path = ServletActionContext.getServletContext().getRealPath("/upload/data");
		// 创建目标文件对象
...
//		}
	...
	public InputStream getAttrInputStream(){
		attrInputStream=ServletActionContext.getServletContext().getResourceAsStream("/upload/data/" + fileName);
